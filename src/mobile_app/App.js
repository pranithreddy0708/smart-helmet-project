...
export default function App() {
    ...
    return ( <
        ...
        <
        Text style = { styles.headerTitle } > 🏍️Smart Helmet System < /Text> <
        View style = {
            [styles.connDot,
        ...
        { /* Main Status Card */ } <
        View style = {
            [styles.statusCard, { borderColor: currentStatus.color }] } >
        <
        Text style = { styles.statusIcon } > { currentStatus.icon } < /Text> <
        Text style = {
            [styles.statusText, { color: currentStatus.color }] } > { currentStatus.label } <
        /Text> {
            confidence > 0 && ( <
...
function StatBox({ label, value, color }) {
    return ( <
        ...
        <
        Text style = {
            [styles.statValue, { color }] } > { value } < /Text> <
